...
func RegisterUserGroup(e *echo.Echo) {
	...
	apiUser.POST("", cont.CreateUserController, middleware.JWT([]byte(os.Getenv("API_SECRET"))))
	apiUser.POST("/auth", cont.AuthUserController)
	apiUser.GET("/test", func(c echo.Context) error {
